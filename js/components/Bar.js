...
export default class Bar extends React.Component {
  ...
  drawBar(){
    ...
    let links = (this.props.dateRange && this.props.dateRange!== 'customize') ? '#/allOrders/'+this.props.dateRange+'/'+this.props.status : (this.props.dateRange === 'customize') ? '#/OrdersByRange/'+this.props.status+'/'+this.props.fromDate+'/'+this.props.toDate : '#/parcels/'+ deliverydays +'/' +this.props.index;
